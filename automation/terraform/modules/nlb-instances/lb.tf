resource "aws_alb" "front_end" {
  name    = "${var.pr_env}-${var.project_name}-${var.pr_region}-LB"
  ...
  //access_logs {
  //  bucket = "${var.pr_env}-${var.project_name}-${var.pr_region}-BKT"
  //  prefix = "log"
  //}
  tags = {
    "Name"                 = "${var.pr_env}-${var.project_name}-${var.pr_region}-LB"
...
//      "Principal": "*",
//      "Action": "s3:*",
//      "Resource": "arn:aws:s3:::${var.pr_env}-${var.project_name}-${var.pr_region}-BKT/*",
//      "Condition": {
...
//  force_destroy = true
//  tags = {
//  "Name" = "${var.pr_env}-${var.project_name}-${var.pr_region}-BKT"
//  "automation"="${var.automation}"
//  "environment"="${var.pr_env}"
//  "region"="${var.pr_region}"
//  }
...
resource "aws_alb_target_group" "front_end" {
  name     = "${var.pr_env}-${var.project_name}-${var.pr_region}-TG"
